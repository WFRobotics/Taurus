...
/**
 * This class is for logging of information. Initially it will only be
 * plain text data to the console but it can be further implemented
 * later to send actual quantitative data to the dashboard.
...
public class Logger {
     ...
     * @param tag The desired log tag for more information.
